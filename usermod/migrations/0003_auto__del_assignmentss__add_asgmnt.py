...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'asgmnt'
        db.create_table(u'usermod_asgmnt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('assignment', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('doi', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('submitted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'usermod', ['asgmnt'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'asgmnt'
        db.delete_table(u'usermod_asgmnt')
    ...
    models = {
        ...
        u'usermod.asgmnt': {
            'Meta': {'object_name': 'asgmnt'},
            'assignment': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'doi': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
